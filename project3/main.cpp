...
int main(int numArguments, char **arguments) {
    ...
    //Planet &earth_2d = Solar_System.createPlanet(vector3(1, 0, 0), vector3(0, 2*M_PI, 0), 3e-6);
    //Planet &too_fun = Solar_System.createPlanet(vector3(1, 0, 0), vector3(0, 2.0*M_PI, 0), 3e-6);
    ...
    cout << "Angular momentum before: " << angmom_bf << endl;
    cout << "Angular momentum after: " << angmom_af << endl;
