...
positions = loadtxt('positions_3body.txt')
n = len(positions[:,0])/3
...
ax.plot(pos_sun[:,0], pos_sun[:,1], pos_sun[:,2], 'y')
ax.plot(pos_earth[:,0], pos_earth[:,1], pos_earth[:,2], c='b')
ax.plot(pos_jupiter[:,0], pos_jupiter[:,1], pos_jupiter[:,2], c='orange')
